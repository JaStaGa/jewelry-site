        ...
        <footer className="border-t border-border mt-16">
            <div className="mx-auto max-w-6xl px-4 py-10 grid gap-8 md:grid-cols-4">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li><a href="mailto:info@example.com" className="hover:text-(--gold)">info@example.com</a></li>
                        <li><a href="tel:+10000000000" className="hover:text-(--gold)">+1 (000) 000-0000</a></li>
                    </ul>
                </div>
            </div>
            <div className="text-xs text-muted px-4 py-6 mx-auto max-w-6xl">
